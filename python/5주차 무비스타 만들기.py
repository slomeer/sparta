...
@app.route('/')
def home():
    return render_template('5주차 무비스타.html')
...
def stars_list():
    ...
    star_list = list(db.mystar.find({}, {'_id':0}).sort("like", -1))
    return jsonify({'result': 'success','msg':'list 연결되었습니다!', 'stars_list':star_list})
